...
The name of the error, intended to be used as the `error` parameter as described by `6749` in `Section 4.1.2.1 <6749#section-4.1.2.1>`, `Section 4.2.2.1 <6749#section-4.2.2.1>` and `Section 5.2 <6749#section-5.2>`, as well as `Section 3.1 of RFC 6750 <6750#section-3.1>`.
